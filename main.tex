...
\resumeSubHeadingListStart
  \resumeEducationHeading
    ...
    {Bachelor of Science in Computer Science}{GPA: 3.96/4.00}{Aug 2020 -- May 2024}{}
\resumeSubHeadingListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Development Engineer Intern}{May 2023 \textbf{--} Aug 2023}
        \resumeItemListStart
          \resumeItem{Developed PyQt app, providing users with better data visualization capabilities of the AXI read/write transactions.}
          \resumeItem{Utilized Python libraries: Matplotlib to create readable graphs, NumPy \& SciPy to perform numerical computations.}
