...
\vspace{-0.1cm} % Adjust vertical space as needed
\resumeSubHeadingListStart
  \resumeEducationHeading
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{FastOrder} $|$ \emph{ASP.NET, Web Services}}{}
          \resumeItemListStart
            \resumeItem{Deploy a Service-Oriented Web App, using \textbf{ASP.NET}, on Web Server that imitates an E-Commerce Site for 1K+ users.}
            \resumeItem{Execute 3+ ASPX pages, for Users \& Staff, calling Web Services to Encrypt data, store cookies, update Cart and pay.}
            \resumeItem{Create 5+ \textbf{WCF} \& \textbf{RESTful Services} to manipulate XML files data, eliminating the need of Database by 100\%.}
          \resumeItemListEnd
