    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{ConnectSocial} $|$ \emph{Java, Scene-Builder, JavaFX, MySQL, JDBC API} $|$ \emph{\href{https://github.com/agupt295/ConnectSocial}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Devised a full stack app that let users make friends, post publicly and like \& comment on others' posts.}
            \resumeItem{Led a team of 4 students to build the GUI using \textbf{Scene Builder}, backend using \textbf{Java} \& database using \textbf{MySQL}.}
...
\section{Honors \& Certifications}
  ...
  \resumeSubHeadingListStart
    \small{\item{
      \textbf{Dean's List: }{Awarded for 8 consecutive semesters for excellent performance, and maintaining a GPA of 3.96 out of 4.0.} \\ \vspace{3pt}
      \textbf{AWS Cloud Practitioner Essentials: }{Completed certification from Coursera verified by AWS.} \\ \vspace{3pt}
